  ...
  return (
    <div className="flex items-center justify-center w-full my-10">
      <motion.form onSubmit={searchMovieFn} animate={{ top: 0, opacity: 1 }} transition={{ duration: 0.5, ease: "easeInOut", delay: 0.2 }} initial={{ top: -50, position: "relative", opacity: 0 }} className="w-11/12 mx-auto text-center">
        ...
        <button className={`absolute py-3 px-5 text-white duration-300  translate-y-[0.40rem] md:translate-y-[1rem] -translate-x-[6.2rem] md:-translate-x-[6.7rem] bg-blue-600 rounded-md shadow-md focus:bg-blue-800`}>Search</button>
      </motion.form>
    </div>
  );
};
