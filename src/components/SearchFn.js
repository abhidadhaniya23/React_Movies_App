  ...
  return (
    <div className="flex items-center justify-center my-10">
      <form onSubmit={searchMovieFn} className="w-full mx-auto text-center">
        ...
        <Link to={`/movie/${txt}`} className={`absolute p-3 text-white duration-300 translate-y-[0.45rem] -translate-x-[5rem] bg-blue-600 rounded-md shadow-md focus:bg-blue-800`}>
          Search
        </Link>
      </form>
    </div>
